...
namespace TodoApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cmbSort.Items.AddRange(new object[] { "alfabet: up", "alfabet: down", "Data: up", "Data: down" });
            this.cmbSort.SelectedIndex = 3;
            this.cmbSort.SelectedIndexChanged += this.MainUpdate;
